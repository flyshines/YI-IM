...
public class RedisDaoImpl implements Dao {
    ...
    @Override
    public void setOnline(String clientId, Online online) {
        // TODO update time userInfoService.updateLastActiveTime(Integer.valueOf(online.getUserId()));
        redisTemplateUtil.put(IMConstants.REDIS_IM_ONLINE_USER_PREFIX, online.getUserId(), JSONUtil.toJsonStr(online));
    }
    ...
    public void removeOnline(String userId) {
        redisTemplateUtil.delete(IMConstants.REDIS_IM_ONLINE_USER_PREFIX, userId);
    }
